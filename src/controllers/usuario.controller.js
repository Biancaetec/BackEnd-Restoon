...
import { z } from "zod";
import { create } from "../models/usuario.model.js";
...
export const createUser = async (req, res) => {
  try {
    ...
    // Retornar sucesso com o id criado (assumindo que result tem lastID ou lastInsertRowid)
    res.status(201).json({
    ...
    if (error instanceof z.ZodError) {
      // Montar o array de erros no formato desejado
